...
class KsuCliRepository(context: Context) {
    ...
    suspend fun isOfficialSignature(packageResourcePath: String): Boolean =
        withContext(Dispatchers.IO) {
            ...
            out.firstOrNull()?.trim()
                .orEmpty() == "size: 0x332, hash: 3d6926592f6aa0c5fdbc0f850f8971e606fadbb84068d8e556c43534aa4fd40a"
        }
    ...
    /**
     * Load a KPM module from a .ko file or directory
     * @param path Path to the .ko file or module directory
     * @param args Optional arguments passed to the module
     * @return Shell output (usually success message or error)
     */
    ...
    /**
     * Unload a loaded KPM module by its name
     * @param name The name of the KPM module (as shown in `kpm list`)
     * @return Shell output
     */
    ...
    /**
     * Get the number of currently loaded KPM modules
     * @return count, or 0 if command fails
     */
    ...
    /**
     * List loaded KPM modules (one per line)
     * @return String containing module names, or empty string on error
     */
    ...
    /**
     * Get detailed information about a specific KPM module
     * @param name Module name
     * @return Module info as string (JSON or formatted)
     */
    ...
    /**
     * Send a control command to a KPM module
     * @param name Module name
     * @param args Control arguments
     * @return Exit code (0 usually means success, -1 on error)
     */
    ...
    /**
     * Get the version of the KPM subsystem
