...
static apk_sign_key_t apk_sign_keys[] = {
    { EXPECTED_SIZE_RESUKISU, EXPECTED_HASH_RESUKISU }, /* ReSukiSU/ReSukiSU (custom) */
#ifdef CONFIG_KSU_MULTI_MANAGER_SUPPORT
    // 原版 ReSukiSU 官方签名
    { EXPECTED_SIZE_RESUKISU_OFFICIAL, EXPECTED_HASH_RESUKISU_OFFICIAL }, /* ReSukiSU Official */
